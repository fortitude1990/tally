...
class CustomTabBar: UITabBar {
    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        let oneItem:UITabBarItem = UITabBarItem.init(title: "首页", image: UIImage.init(named: "明细调账"), tag: 0)
        let twoItem:UITabBarItem = UITabBarItem.init(title: "总结", image: UIImage.init(named: "明细调账"), tag: 1)
        let threeItem:UITabBarItem = UITabBarItem.init(title: "首页", image: UIImage.init(named: "明细调账"), tag: 2)
        let fourItem:UITabBarItem = UITabBarItem.init(title: "总结", image: UIImage.init(named: "明细调账"), tag: 3)
